...
<html>
  <head>
    ...
    <title>Auctus Trading Notification</title>
    <style>
	.logo { 
		background-size: 105px;
		width: 105px;
		height: 28px;
		background-image: url('https://auctus.azureedge.net/platform/logo_trading_black.png');
	}
	.social-media {
              ...
              <tr>
                <td class=""wrapper"" style=""font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; color: #ffffff;"">
                  <table cellspacing=""0"" cellpadding=""0"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;"">
					...
					<tr style=""width:100%;background-image:url('https://auctus.azureedge.net/platform/mail_@backImage.png');background-position: center;height:200px;vertical-align:middle;"">
