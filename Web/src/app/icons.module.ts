...
import { faLock, faChevronUp, faChevronDown, faTimes, faCheck, faArrowRight, faCircle } from '@fortawesome/free-solid-svg-icons';
...
library.add(faLock, faChevronUp, faChevronDown, faTwitter, faFacebookF, faTelegramPlane, faGoogle, faTimes, faCheck, faArrowRight, faCircle);
@NgModule({
