...
import { faLock, faChevronUp, faChevronDown, faTimes, faCheck  } from '@fortawesome/free-solid-svg-icons';
...
library.add(faLock, faChevronUp, faChevronDown, faTwitter, faFacebookF, faLinkedinIn, faGoogle, faTimes, faCheck);
@NgModule({
